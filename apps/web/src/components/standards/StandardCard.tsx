    ...
    <article className="relative flex flex-col gap-16 px-8 py-24 transition-colors hoverable:hover:bg-surface-card/60 focus-within:bg-surface-card/60">
      <div className="flex flex-col items-start gap-8 lg:flex-row lg:items-center lg:gap-24">
        ...
        <Link
          ...
          className="shrink-0 rounded-sm text-link text-text-secondary underline underline-offset-4 hoverable:hover:text-brand-primary hoverable:hover:no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary"
        >
